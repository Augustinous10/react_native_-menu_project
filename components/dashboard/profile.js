...
export default function Profile(){
    ...
    return (
        <View style={{flex:1,marginTop:50,marginLeft:50}}>
            ...
            fontWeight:'800',
            marginTop:10}}>Augustine Nshimiyimana</Text>
            <Text style={{fontWeight:'600',
        marginBottom:1}}>tel:+250 781345944</Text> 
        <Text style={{fontWeight:'600',
        marginBottom:10}}>Email: Augustinous10@gmail.com</Text> 
            </View>
            <View>
                <Text style={{fontSize:18,
                marginTop:50,
                marginRight:40}}>
                    Hello mr/mrs Augustine Nshimiyimana thank you for being with us 
                    if you receive your delivered food please notify us by click the approve button!
                    if not contact us on : +250 781345944!
                </Text>
